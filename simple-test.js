// Simple test runner for EnhancedInsightsDashboard component
import React from 'react';
import { render, screen } from '@testing-library/react';
import { JSDOM } from 'jsdom';
import EnhancedInsightsDashboard from './src/components/EnhancedInsightsDashboard';
...
describe('EnhancedInsightsDashboard', () => {
  ...
  test('shows personalized insights when data is available', () => {
    render(<EnhancedInsightsDashboard sessions={mockSessions} />);
...
// Run the tests
console.log('Running tests for EnhancedInsightsDashboard...');